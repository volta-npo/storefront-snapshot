export const v1 = {
    "workbench": "Before/After Transformation Studio",
    "table": "Capture ledger",
    "metrics": [
        "Delta Completeness",
        "Proof Readiness",
    ...
    "sampleScenario": "Volta chapter uses Storefront Snapshot with Riverside Community Bakery to produce a release-ready v1.0 packet."
};
